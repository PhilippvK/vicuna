...
module demo_top #(
    ...
    logic        mem_ireq;
    logic [31:0] mem_iaddr;
    logic        mem_iwe;
    logic  [3:0] mem_ibe;
    logic [31:0] mem_iwdata;
    logic        mem_irvalid;
    logic        mem_ierr;
    logic [31:0] mem_irdata;
    ...
    vproc_top #(
        ...
        .mem_ireq_o    ( mem_ireq                     ),
        .mem_iaddr_o   ( mem_iaddr                    ),
        // .mem_iwe_o     ( mem_iwe                      ),
        // .mem_ibe_o     ( mem_ibe                      ),
        // .mem_iwdata_o  ( mem_iwdata                   ),
        .mem_irvalid_i ( mem_irvalid                  ),
        .mem_ierr_i    ( mem_ierr                     ),
        .mem_irdata_i  ( mem_irdata                   ),
        .pend_vreg_wr_map_o (                       )
    );
    ...
    assign mem_ierr   = mem_irvalid & (~(sram_irvalid | hwreg_rvalid));
    assign mem_irdata = hwreg_rvalid ? hwreg_rdata : sram_irdata;
    ...
    ram32 #(
        ...
        .clk_i     ( clk                                             ),
        .rst_ni    ( rst_n                                           ),
        .req_i     ( mem_ireq & ((mem_iaddr & ~MEM_MASK) == MEM_START) ),
        .we_i      ( mem_ireq & mem_iwe                                ),
        .be_i      ( mem_ibe                                          ),
        .addr_i    ( mem_iaddr                                        ),
        .wdata_i   ( mem_iwdata                                       ),
        .rvalid_o  ( sram_irvalid                                     ),
        .rdata_o   ( sram_irdata                                      )
    );
